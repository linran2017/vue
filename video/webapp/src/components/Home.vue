<template>
 <div>
   ...
   <swiper :options="swiperOption" :not-next-tick="notNextTick" ref="mySwiper">
     <!-- slides -->
     <swiper-slide v-for="v in sildes" :key="v.id">
...
<script>
    export default {
        ...
        mounted(){
            //推荐课程
            this.axios.get('http://laravel.linran136.com/api/commendLesson/4').then((response) => {
                this.commendLesson=response.data.date;
            })
            //热门课程
            this.axios.get('http://laravel.linran136.com/api/hotLesson/3').then((response) => {
                this.hotLesson=response.data.date;
            })
            //轮播图
            this.axios.get('http://laravel.linran136.com/api/sildesLesson/4').then((response) => {
                console.log(response);
                this.sildes=response.data.date;
            })
        },
        data(){
            return {
