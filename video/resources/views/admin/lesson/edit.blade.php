...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li><a href="/admin/lesson">列表</a></li>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="inputID" class="col-sm-2 control-label">课程名称:</label>
                    <div class="col-sm-10">
                        <input type="text" name="title" id="inputID" class="form-control" value="{{$lesson['title']}}" title="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputID" class="col-sm-2 control-label">课程介绍:</label>
                    <div class="col-sm-10">
                        <textarea name="introduce" class="form-control">{{$lesson['introduce']}}</textarea>
                    </div>
                </div>
            <div class="form-group">
                <label for="inputID" class="col-sm-2 control-label">所属标签:</label>
                <div class="col-sm-10">
                    <div class="checkbox">
                        @foreach($tags as $v)
                            <label>
                                <input type="checkbox" name="tag_id[]" value="{{$v['id']}}" {{in_array($v['id'],$tagLesson)?'checked':''}} />{{$v['name']}}
                            </label>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="input-group" style="margin-top:5px;">
                            <img src="{{asset($lesson['preview'])}}" class="img-responsive img-thumbnail" width="150">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="iscommend" {{$lesson['iscommend']==1?'checked':''}} value="1" />是
                        </label>
                        <label class="radio-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="radio-inline">
                            <input type="radio" name="ishot" {{$lesson['ishot']==1?'checked':''}} value="1" />是
                        </label>
                        <label class="radio-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="click" id="inputID" class="form-control" value="{{$lesson['click']}}" title=""
                               required="required">
                    </div>
                </div>
        ...
        <div class="panel panel-default" id="app">
            ...
            <div class="panel-body">
                <div class="panel panel-default" v-for="(v,k) in videos">
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="inputID" class="col-sm-2 control-label">视频名称:</label>
                            <div class="col-sm-10">
                                <input type="text" id="inputID" class="form-control" v-model="v.title" required="required">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <textarea name="videos" hidden rows="20" cols="80">@{{videos}}</textarea>
    ...
    <script>
        require(['vue'],function (Vue) {
            new Vue({
                ...
                methods:{
                    add(){
                        field={title:'',path:'',id:'hd'+Date.parse(new Date())};
