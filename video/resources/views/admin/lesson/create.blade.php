        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="click" id="inputID" class="form-control" value="0" title=""
                               required="required">
                    </div>
                </div>
                ...
                <div class="panel panel-default" v-for="(v,k) in videos">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" id="inputID" class="form-control" v-model="v.title" value="" title=""
                                       required="required">
                            </div>
                        </div>
                        <div class="form-group">
